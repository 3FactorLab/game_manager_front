...
export const collectionService = {
     ...
     */
    async updateStatus(id: string, status: CollectionItem["status"]): Promise<CollectionItem> {
        const { data } = await apiClient.put<CollectionItem>(`/collection/${id}/status`, { status });
        return data;
    },
