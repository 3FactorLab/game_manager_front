...
const GameDetails = () => {
    ...
    if (error || !game)
        return <div style={{ padding: "4rem", textAlign: "center", color: "var(--error)" }}>Game not found</div>;
                    ...
                    {game.assets?.screenshots && game.assets.screenshots.length > 0 && (
                        <Card>
                            ...
                            <div className={styles.gallery}>
                                {game.assets.screenshots.map((screenshot, i) => (
                                    <img
                                        key={i}
                                        src={screenshot}
                    ...
                    <Card padding="md">
                        ...
                        {game.score && (
                            <div className={styles.detailRow} style={{ borderBottom: "none" }}>
                                ...
                                <span style={{ color: "var(--success)", fontWeight: "bold" }}>{game.score}/10</span>
                            </div>
                        )}
                    </Card>
                </aside>
